...
module.exports = "<div>\n  <div class=\"title\">Events</div>\n  <div class=\"title\">Video Gallery</div>\n  <br>\n  <div *ngFor=\"let eve of lstVideos\">\n    <hr>\n    <div class=\"subtitle\"> {{eve.title}}</div>\n    <div class=\"subtitle\"> {{eve.date |date: 'shortDate'}}</div>\n    <div class=\"subtitle\"> {{eve.speakers}}</div>\n    <div class=\"subtitle\"> {{eve.description}}</div>\n    <!-- <button (click)=\"ClickDetails(eve.id)\">See details</button> -->\n  </div><hr *ngIf=lstVideos.length >\n</div>\n\n<!-- \n  \ngit remote add origin \"https://github.com/MatAravena/OmniSavyProj.git\"\nng deploy --base-href=/OmniSavyProj/\nng deploy --repo=https://github.com/MatAravena/OmniSavyProj.git\nng deploy your-angular-project --base-href=/OmniSavyProj/\nng deploy --repo=https://github.com/MatAravena/OmniSavyProj.git \n\n\nFuncionaron ******\nnpm i angular-cli-ghpages\nng build --prod --base-href \"https://MatAravena.github.io/OmniSavyProj/\"\nangular-cli-ghpages — dir=dist/OmniSavyProj\n******\n\n-->"
